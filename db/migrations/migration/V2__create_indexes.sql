...
CREATE INDEX idx_archetype_short_i18n_pt ON archetype ((short_i18n->>'pt'));
CREATE INDEX idx_archetype_long_i18n_pt ON archetype ((long_i18n->>'pt'));

CREATE INDEX idx_archetype_name_i18n_en ON archetype ((name_i18n->>'en'));
CREATE INDEX idx_archetype_short_i18n_en ON archetype ((short_i18n->>'en'));
CREATE INDEX idx_archetype_long_i18n_en ON archetype ((long_i18n->>'en'));
